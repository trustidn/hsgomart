    ...
    <template v-else>
      ...
      <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">WhatsApp Number</label>
            <input v-model="form.whatsapp_number" type="tel" placeholder="08xxxxxxxxxx" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100" />
            <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">Tenant dapat mengirim pesan via WhatsApp ke nomor ini.</p>
          </div>
        </div>
      </div>
